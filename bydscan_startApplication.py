...
file_handler = logging.FileHandler('D://byd.log')
...
def startApplication():
    ...
    # time.sleep(2)
    subprocess.Popen("D:\\SVNsoftwarePackageRelease\\BYDCollectExe_2023_07_19\\bydFrontEndGui.exe")
...
def connectState():
    ...
    if tubePixel & dectectorPixel & commPixel & machinalPixel & safetyPixel1 & safetyPixel2 != True:
        pyautogui.screenshot('D:\\BYDscanTest\\bydscript\\Data\\image\\communication.png')
        # return "通讯连接失败"
        communication+=1
...
def tubePreheat():
    ...
    scanButton.Click()
    #确认开始预热
    # confirmPreheatButton=uiautomation.ButtonControl(AutomationId='')
    # confirmPreheatButton.Click()
    #判断是否开始曝光
    start_exposureState()
    time.sleep(900)
    #判断是否成功完成曝光
...
def operateWindowsPosition(point_x1, point_y1, point_x2, point_y2):
    ...
    for i in range(len(temp)):
        ...
        if temp[i] < point_x1:
            ...
            local = temp[i]
def baofuMeasure():
    baofumeasureButton=uiautomation.ButtonControl(AutomationId='bydQWidgetPlatformClass.stackedWidgetPlatfotm.page_Scan.bydQWidgetScanClass.widget.widget_3.widget_6.widget_9.widget_12.widget_40.widget_41.pushButton_btdCT_Wrapping')
    baofumeasureButton.Click()
    #1.直接右键单击，左键单击
    baofumeasureButton.Click(244, 495)
    baofumeasureButton.Click(455, 588)

def distanceMeasure():
    distancemeasureButton=uiautomation.ButtonControl(AutomationId='bydQWidgetPlatformClass.stackedWidgetPlatfotm.page_Scan.bydQWidgetScanClass.widget.widget_3.widget_6.widget_9.widget_12.widget_40.widget_41.pushButton_btdCT_Distance')
    distancemeasureButton.Click()
def angleMeasure():
    AnglemeasureButton = uiautomation.ButtonControl(AutomationId='bydQWidgetPlatformClass.stackedWidgetPlatfotm.page_Scan.bydQWidgetScanClass.widget.widget_3.widget_6.widget_9.widget_12.widget_40.widget_41.pushButton_btdCT_Angle')
    AnglemeasureButton.Click()
# def exitApplication():
#     closeApplication=uiautomation.ButtonControl(searchDepth=3,Name='关闭')
#     closeApplication.Click()
def angleSwith():
    angleButton1 = uiautomation.ButtonControl(
    ...
    angleButton2 = uiautomation.ButtonControl(
    ...
    angleButton3 = uiautomation.ButtonControl(
    ...
    angleButton4 = uiautomation.ButtonControl(
    ...
    angleButton5 = uiautomation.ButtonControl(
